...
#pragma HLS INTERFACE s_axilite port=return bundle=control
		...
		unsigned char IN1[960][540];
		unsigned char IN2[960][540];
		unsigned char OUT[960][540];
		int index1 = 0;
		int index2 = 0;
		int index3 = 0;


#pragma HLS array_partition variable=IN1 dim=2 cyclic factor=50
#pragma HLS array_partition variable=IN2 dim=2 cyclic factor=50
#pragma HLS array_partition variable=OUT dim=2 cyclic factor=50
