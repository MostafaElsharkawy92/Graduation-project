...
int main(int argc, char* argv[]) {
	...
	if (!lines.empty() && lines.size() > 2) {
	   ...
	   // cout << endl;
		...
		//std::cout << "negSum: " << negSum << " negSlopesGood.size(): " <<size_in_bytes negSlopesGood.size() << " negSlopeMean: " << negSlopeMean << endl;
		...
		cout << "time before kernel is : " << cpu_time_used << endl;
		...
		cout << "time of kernel is : " << cpu_time_used_1 << endl;
		...
		cout << "time after kernel is : " << cpu_time_used_2 << endl;
		cout << "--------------------------------------------" << endl;
		cout << "Total Execution time is " << cpu_time_used + cpu_time_used_1 + cpu_time_used_2 << endl;
		cout << "Created output image" << endl;

		//q.enqueueUnmapMemObject(buffer_in_1, ptr_in_1);
		//q.enqueueUnmapMemObject(buffer_in_2, ptr_in_2);
